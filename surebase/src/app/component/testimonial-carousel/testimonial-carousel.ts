  ...
  slides: Slide[] = [
    {
      id: 1,
      title:
        'With insurance penetration in Nigeria below 3% and rapidly growing digital adoption across fintechs and banks, Surebase fills a critical gap. We bridge fragmented insurance systems, meeting the increasing demand for embedded insurance across travel, health, and banking sectors.',
      description: '',
      person: {
    ...
    },
    {
      id: 2,
      title:
        'Our strategy combines a unified API, digital dashboards, and robust infrastructure for 99.99% uptime and full regulatory compliance, ensuring unmatched scale and security.',
      description: '',
      person: {
    ...
    },
    {
      id: 3,
      title:
        "Whether you're an insurer looking to expand your digital footprint or a broker seeking streamlined access to a vast product portfolio, Surebase is your indispensable partner.",
      description: '',
      person: {
        name: 'Darrell Steward',
        position: 'Chief Technology Officer',
